...
MODULE parameters
  ...
  IMPLICIT NONE
  SAVE
  INTEGER, PARAMETER :: mprxparm=8, mptlparm=mprxparm+12, mprock=999
...
MODULE control
  ...
  INTEGER :: iphschgmx
  INTEGER :: informt, informtp
  INTEGER :: iprsat, iprden, iprvis, iprpot, iprvel, iprbcflow, &
       iprsource, iprpmprop, iprdimno
  INTEGER :: n_locations
...
MODULE units
  ...
  CHARACTER(LEN=80) :: version_string='$Name: v3_2_0 $'
